...
var tasaIGV = 0.18; // Tasa de IGV del 18% (ajusta según tu país)
...
function actualizarTotalCarrito() {
    ...
    // Recorremos cada elemento del carrito para actualizar el subtotal
    for (var i = 0; i < carritoItems.length; i++) {
        var item = carritoItems[i];
        var precioElemento = item.getElementsByClassName('carrito-item-precio')[0];
        // Quitamos el símbolo "S/" y el espacio en blanco.
    ...
    document.getElementsByClassName('carrito-precio-subtotal')[0].innerText = 'S/' + subtotal.toLocaleString("es");
